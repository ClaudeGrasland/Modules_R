...
-   vndensity\]{.underline} : similaire à density mais la valeur maximale ici est de 1.
...
[5. Re-coder la variable « POP » en « Population » en trois catégories :]{.question}

1)  Moins de 10 millions
2)  10 -- 25 millions
3)  \> 25 millions

[6. Faire une représentation graphique de l'effectif des pays par sous-région.]{.question}

[7. Ajouter les étiquettes (titre du graphique, étiquette axe abscisse, axe des ordonnées) au graphique.]{.question}

[8. Faite la boite à moustache de l'espérance de vie à la naissance par sous-région.]{.question}

[9. Faite la boite à moustache de l'espérance de vie à la naissance par sous-région.]{.question}

Note : faites les largeurs des boites à moustaches proportionnelles à l'effectif de pays par sous-région

[10. Ajouter les étiquettes (titre du graphique, étiquette axe abscisse, axe des ordonnées) au graphique.]{.question}
