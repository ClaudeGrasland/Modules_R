...
# Enchaînement des opérations avec le [*pipe*]{.underline}
...
# Quelques fonctions usuelles de manipulation des tableaux de données avec dplyr
...
# Pour aller plus loin \~ autres fonctions utiles
