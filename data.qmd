...
Le principal jeu de données utilisé dans les différents modules est une compilation de données fournie par ... et .... Il comporte des données sur l'ensemble des pays africains à l'échelle nationale.
